...
def convert_annots_from_classification_to_segmentation(
    ...
    Args:
        ...
        file_list_cm: txt file with filenames of cm folder
        file_list_sp: txt file with filenmaes of sp folder
    ...
    cm_file = open(file_list_cm, 'r')
    cm_lines = cm_file.readlines()

    sp_file = open(file_list_sp, 'r')
